...
namespace GLT {
	...
	struct input_action {
		...
		T get_data() const {
			...
			switch (value) {
			case GLT::input::action_type::_bool:
				return data.boolean;

			case GLT::input::action_type::_1D:
				return data.vec_1d;

			case GLT::input::action_type::_2D:
				return data.vec_2d;

			case GLT::input::action_type::_3D:
				return data.vec_3d;
		...
		*/
		...
		DEFAULT_GETTER_SETTER_C(std::string_view, name)
