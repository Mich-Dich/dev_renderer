...
// 	};
	...
	struct transform_component {
		...
		DEFAULT_CONSTRUCTORS(transform_component);
...
// 		DEFAULT_CONSTRUCTORS(ID_component);
...
// 		DEFAULT_CONSTRUCTORS(name_component);
...
// 		DEFAULT_CONSTRUCTORS(enum_tag_component);
...
// 		DEFAULT_CONSTRUCTORS(flag_tag_component);
...
// 		DEFAULT_CONSTRUCTORS(simple_lifetime_component);
...
// 		DEFAULT_CONSTRUCTORS(lifetime_component);
...
// 		DEFAULT_CONSTRUCTORS(mesh_component);
// 		mesh_component(ref<GLT::geometry::mesh_asset> mesh_asset_ref)
// 			: mesh_asset(mesh_asset_ref) {}

// 		mobility									mobility_data = mobility::locked;
// 		bool										shoudl_render = true;
// 		ref<GLT::geometry::mesh_asset>				mesh_asset = nullptr;				// MAYBE: make private
...
// 	//	DEFAULT_CONSTRUCTORS(static_mesh_component);

// 	//	glm::mat4							transform = glm::mat4(1);
// 	//	ref<GLT::geometry::mesh_asset>		mesh_asset;
...
// 		DEFAULT_CONSTRUCTORS(relationship_component);
...
// 		DEFAULT_CONSTRUCTORS(procedural_mesh_component);
...
// 		mobility									mobility_data = mobility::locked;
// 		bool										shoudl_render = true;
// 		//ref<GLT::geometry::mesh_asset>			mesh_asset = nullptr;	// MAYBE: Move mesh_asset to the component for better performance in rendering
