...
namespace GLT {
	...
	struct window_attrib {
		...
		window_attrib(const std::string title = "Small renderer", const u32 width = 1600, const  u32 height = 900, const  bool vsync = false, const EventCallbackFn& callback = nullptr)
