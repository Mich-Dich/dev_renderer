...
namespace GLT::UI {
	...
	static std::filesystem::path ini_file_location = GLT::config::get_filepath_from_configtype_ini(util::get_executable_path().parent_path(), config::file::imgui).c_str();
	...
	public:
		...
		DEFAULT_GETTER_SETTER_ALL(bool, show_renderer_metrik);
